# movieverse
<p> A web application where users are able to search for all types of movies as well as search by category using a third-party API. User authentication is required in order to access the homepage and all other features. The application has functionalities that allow users to add/remove movies in/from watchlist or watched list and the users also can share the list with friends by sending though email.<p>
